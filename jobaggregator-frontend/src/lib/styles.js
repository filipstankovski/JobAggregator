export const S = {
  ...
  resultsTop: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '1rem', flexWrap: 'wrap', marginBottom: '1.25rem' },
  resultsMeta: { fontSize: '0.8rem', color: 'var(--muted)', fontFamily: 'var(--font-mono)' },
  pagination: { display: 'flex', alignItems: 'center', gap: '0.5rem' },
  pageBtn: { background: 'var(--surface)', color: 'var(--text)', border: '1px solid var(--border)', borderRadius: 8, fontFamily: 'var(--font-ui)', fontSize: '0.84rem', fontWeight: 700, padding: '0.5rem 0.85rem', cursor: 'pointer', transition: 'all 0.15s' },
  pageBtnDisabled: { opacity: 0.45, cursor: 'not-allowed' },
  pageText: { fontFamily: 'var(--font-mono)', fontSize: '0.78rem', color: 'var(--muted)', minWidth: 64, textAlign: 'center' },
  grid: { display: 'grid', gridTemplateColumns: 'repeat(3, minmax(0, 1fr))', gridAutoRows: '1fr', alignItems: 'stretch', gap: '1rem' },
  cardWrap: { height: '100%' },
